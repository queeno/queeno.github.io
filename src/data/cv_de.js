export const em_de = {
  ...
  experience: [
    ...
    },
    {
      ...
      company: "Microsoft",
      location: "London, UK",
      period: "Nov. 2020 - März 2021",
      points: [
        { bold: "Architektonische Wiederherstellung", text: "Leitung der architektonischen Wiederherstellung einer kritischen Handelsplattform-Migration für die London Stock Exchange Group (Refinitiv)." },
        { bold: "Durchsatzoptimierung", text: "Lösung von Durchsatzblockaden durch Optimierung der Architektur für AKS (Kubernetes) und EventHubs, Verkürzung der Lieferung von Jahren auf Monate." }
      ]
    },
    {
      ...
      location: "London, UK",
      period: "März 2020 - Okt. 2020",
      points: [
        { bold: "Performance Engineering", text: "Erzielung einer Leistungssteigerung von ca. 30% bei Suchantwortzeiten durch Profiling von Go- und Java-Microservices." },
        { bold: "Custom Tooling", text: "Entwicklung einer benutzerdefinierten Go-Bibliothek für die Echtzeit-Datenbanksynchronisation über Google Cloud Storage." }
      ]
    },
    {
      ...
      period: "Juni 2019 - März 2020",
      points: [
        { bold: "Migrationsstrategie", text: "Orchestrierung der strategischen Migration des Classifieds-Verticals zu GCP." },
        { bold: "Standardisierung", text: "Architektur standardisierter GKE-Workflows und Bereitstellungsmuster für verteilte Teams." }
      ]
    },
    {
  ...
  languages: [
    { language: "Englisch", proficiency: "C2 - Muttersprachlich / Zweisprachig" },
    { language: "Italienisch", proficiency: "C2 - Muttersprachlich / Zweisprachig" },
    { language: "Deutsch", proficiency: "B2 - Professionelle Arbeitskenntnisse" },
    { language: "Dänisch", proficiency: "A2 - Elementare Kenntnisse" }
  ]
};
