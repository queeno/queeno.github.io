  ...
  experience: [
    ...
    },
    {
      ...
      points: [
        ...
        { bold: "Google (2010-2011)", text: "Corporate Operations Engineer intern on Google's internal IT helpdesk (London, then Dublin); earned multiple peer bonuses and Google's Python Readability certification." }
      ]
    }
  ],
  skills: {
